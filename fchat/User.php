...
class User
{
	...
	{	
		try {
			$this->con = new PDO('mysql:host=localhost;dbname=flowrtid_new', 'flowrtid_newui', 'flow@6508#');
			$this->con->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    		$this->con->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
			// This assumes that you have placed the Firebase credentials in the same directory
			// as this PHP file.
			$serviceAccount = ServiceAccount::fromJsonFile(__DIR__.'/webchat-c2993-firebase-adminsdk-jrnqr-2f8de8452a.json');
