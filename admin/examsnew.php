            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-baseline mb-2">
                  ...
                  <button type="button" onclick="window.location.href='index.php?action=plancreateevaluation&class=<?=$gclass?>&subject=<?=$subjectid?>'" class="btn btn-success btn-icon-text">
...
$( document ).ready(function() {
    $( "#selsubject" ).change(function(e) {
		...
		window.location.href="index.php?action=examsnew&class=<?=$_GET['class']?>&subject="+e.target.value
	});
	let hselsubjectid = $( "#hselsubjectid" ).val();
	if(hselsubjectid==''){
		window.location.href="index.php?action=examsnew&class=<?=$_GET['class']?>&subject="+$( "#selsubject" ).val()
	}
