			  ...
			  <div class="form-group">
				<div class="row">
					<div class="col-6">
						...
						<input type="text" class="form-control d-inline-block wd-80" name='fillblankanswermarks' id='fillblankanswermarks' maxlength=2 size=2 onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false; " value="<?=$data['marks']?>" >
					</div>		
				</div>
			  </div>
			  <div class="form-group">
