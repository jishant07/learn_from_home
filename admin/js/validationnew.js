function evaluationvalid(){
	...
	if((document.getElementById('tot_marks').value).trim()==''){
		alert('Please enter total marks.');
		document.getElementById('tot_marks').focus();
		return false;
	}
	if((document.getElementById('totsections').value).trim()==''){
		alert('Please enter total sections.');
		document.getElementById('totsections').focus();
		return false;
	}
...
function sectionvalid(){
	let totsections = $('#totsections').val();
	let totmarks = $('#totmarks').val();
	let calmarks = 0;
	for(let i=1; i<=totsections;i++){
	if((document.getElementById('section'+i).value).trim()==''){
		alert('Please enter section '+i);
		document.getElementById('section'+i).focus();
		return false;
	}
	if((document.getElementById('marks'+i).value).trim()==''){
		alert('Please enter marks '+i);
		document.getElementById('marks'+i).focus();
		return false;
	}
	calmarks=parseInt(calmarks)+parseInt(document.getElementById('marks'+i).value);
	//alert(calmarks+'::'+totmarks)
	
	}
	if(calmarks!=totmarks){
		alert('Assigned marks and total marks not matched')
		return false;
	}
	return true;	
}
