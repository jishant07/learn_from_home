 ...
 */
class LVideosPresenter : Presenter() {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, item: Any) {
        val movie = item as LVideos
        val cardView = viewHolder.view as ImageCardView

        Log.d(TAG, "onBindViewHolder")
        cardView.titleText = movie.subject_name
        cardView.contentText = "Courses: ${movie.total_courses}"
