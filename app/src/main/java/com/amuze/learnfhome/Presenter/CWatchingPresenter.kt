...
import com.amuze.learnfhome.Modal.CWatching
 ...
 */
class CWatchingPresenter : Presenter() {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, item: Any) {
        val movie = item as CWatching
        val cardView = viewHolder.view as ImageCardView

        Log.d(TAG, "onBindViewHolder")
        cardView.titleText = movie.vtitle
        cardView.contentText = movie.vtitle
